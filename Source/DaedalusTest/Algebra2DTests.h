...
TEST(Vector2D, PerformsAddition) {
	Vector2<int32_t> v1(5, 6);
	Vector2<int32_t> v2(2, 7);
	ASSERT_TRUE((v1 + v2) == Vector2<int32_t>(7, 13));
	ASSERT_TRUE((v1 + 4) == Vector2<int32_t>(9, 10));
}

TEST(Vector2D, PerformsSubtraction) {
	Vector2<int32_t> v1(5, 6);
	Vector2<int32_t> v2(2, 7);
	ASSERT_TRUE((v1 - v2) == Vector2<int32_t>(3, -1));
	ASSERT_TRUE((v1 - 4) == Vector2<int32_t>(1, 2));
	ASSERT_TRUE(-v1 == Vector2<int32_t>(-5, -6));
}

TEST(Vector2D, PerformsMultiplication) {
	Vector2<int32_t> v1(5, 6);
	Vector2<int32_t> v2(2, 7);
	ASSERT_TRUE((v1 * v2) == Vector2<int32_t>(10, 42));
	ASSERT_TRUE((v1 * 4) == Vector2<int32_t>(20, 24));
}

TEST(Vector2D, PerformsDivision) {
	Vector2<int32_t> v1(6, 42);
	Vector2<int32_t> v2(2, 7);
	ASSERT_TRUE((v1 / v2) == Vector2<int32_t>(3, 6));
	ASSERT_TRUE((v1 / 3) == Vector2<int32_t>(2, 14));
}

TEST(Vector2D, Length) {
	Vector2<int32_t> v1(3, 4);
	Vector2<int32_t> v2(10, 0);
	ASSERT_TRUE(DoubleEquals(v1.Length(), 5.0));
	ASSERT_TRUE(DoubleEquals(v2.Length(), 10.0));
}

TEST(Vector2D, Normalizes) {
	Vector2<int32_t> v1(60, 42);
	Vector2<int32_t> v2(2, 1);
	Vector2<int32_t> v3(-75, 23);
	Vector2<int32_t> v4(39, -5);
